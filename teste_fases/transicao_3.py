...
class Transicao_3:
    def __init__(self, janela, gerenciador, mouse, mixer):
        ...
        self.proximaFase = fase_4.Fase4(self.janela, self.gerenciador, self.mouse, self.mixer)

        self.imagem = Botao(0, 0, 160 * 8, 90 * 8, "imagens/background_transicao-3.png", self.janela, None)

        self.imagem_completo = Botao(0, 0, 320 * 8, 90 * 8, "imagens/background_3-4.png", self.janela, None)
        ...
        #canos
        self.cano_esq_cima = Botao(68 * 8, self.pos_inicial, dimensao_canos, dimensao_canos, "imagens/cano2_esq-cima.png", self.janela, None)
        self.cano_cima_dir = Botao(68 * 8, self.pos_inicial, dimensao_canos, dimensao_canos, "imagens/cano2_cima-dir.png", self.janela, None)
        self.cano_baixo_dir = Botao(68 * 8, self.pos_inicial, dimensao_canos, dimensao_canos, "imagens/cano3_cima-baixo.png", self.janela, None)
        ...
        self.opc_cano_baixo_dir = Botao(105 * 8, altura, dimensao_opcoes, dimensao_opcoes, "imagens/cano3_cima-baixo.png", self.janela, None)
